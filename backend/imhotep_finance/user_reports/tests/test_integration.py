...
class ReportsIntegrationTest(TransactionTestCase):
    ...
    def test_complete_report_lifecycle(self):
        ...
        create_transaction(user=self.user, amount=1000, currency='USD', trans_status='deposit', category='Salary', trans_details='Jan salary', transaction_date=date(2024, 1, 15), place='General')
        create_transaction(user=self.user, amount=500, currency='USD', trans_status='withdraw', category='Rent', trans_details='Jan rent', transaction_date=date(2024, 1, 20), place='General')
        create_transaction(user=self.user, amount=1000, currency='USD', trans_status='deposit', category='Salary', trans_details='Feb salary', transaction_date=date(2024, 2, 15), place='General')
