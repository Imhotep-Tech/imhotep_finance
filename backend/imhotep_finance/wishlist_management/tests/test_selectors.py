...
class GetWishlistForUserTest(TestCase):
    ...
    def setUp(self):
        ...
        self.wish_2024 = create_wish(user=self.user, price=500, currency='USD', year=2024, wish_details='2024 wish', link='', place='General')
        self.wish_2025 = create_wish(user=self.user, price=300, currency='USD', year=2025, wish_details='2025 wish', link='', place='General')
