...
from target_management.serializers import TargetCreateSerializer, TargetResponseSerializer, GetScoreResponseSerializer
...
class TargetResponseSerializerTest(TestCase):
    ...
    def test_serialization(self):
        ...
        data = {'id': 1, 'user_id': 1, 'target': Decimal('1000.00'), 'month': 6, 'year': 2024, 'score': Decimal('75.50'), 'created_at': datetime.now()}
...
class GetScoreResponseSerializerTest(TestCase):
    ...
    def test_score_response_serialization(self):
        ...
        data = {'score': Decimal('85.00'), 'target': Decimal('1000.00'), 'month': 6, 'year': 2024, 'score_txt': 'Great job!'}
