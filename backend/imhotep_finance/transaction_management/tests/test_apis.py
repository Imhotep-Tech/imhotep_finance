...
class TransactionCreateApiTest(TestCase):
    ...
    def test_create_transaction_success(self):
        ...
        data = {'amount': '100.50', 'currency': 'USD', 'trans_status': 'deposit', 'category': 'Salary', 'trans_details': 'Monthly payment'}
    ...
    def test_create_transaction_unauthenticated(self):
        ...
        data = {'amount': '100', 'currency': 'USD', 'trans_status': 'deposit'}
        response = self.client.post(self.url, data, format='json')
...
class TransactionListApiTest(TestCase):
    ...
    def setUp(self):
        ...
        for i in range(5):
            create_transaction(user=self.user, amount=100 + i, currency='USD', trans_status='deposit', category=f'Category{i}', trans_details=f'Details {i}', transaction_date=date.today(), place='General')
...
class TransactionUpdateApiTest(TestCase):
    ...
    def test_update_transaction_success(self):
        ...
        data = {'date': str(date.today()), 'amount': '150.00', 'currency': 'USD', 'trans_status': 'deposit', 'category': 'Updated', 'trans_details': 'Updated details'}
        response = self.client.post(self.url, data, format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_update_transaction_not_found(self):
        ...
        data = {'date': str(date.today()), 'amount': '100', 'currency': 'USD', 'trans_status': 'deposit'}
...
class TransactionExportCSVApiTest(TestCase):
    ...
    def setUp(self):
        ...
        create_transaction(user=self.user, amount=100, currency='USD', trans_status='deposit', category='Test', trans_details='Export test', transaction_date=date.today(), place='General')
