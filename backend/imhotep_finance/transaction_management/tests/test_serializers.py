...
from transaction_management.serializers import TransactionInputSerializer, TransactionUpdateSerializer, TransactionFilterSerializer, CSVFileUploadSerializer
...
class TransactionInputSerializerTest(TestCase):
    ...
    def test_invalid_amount_zero(self):
        ...
        data = {'amount': '0', 'currency': 'USD', 'trans_status': 'deposit'}
        serializer = TransactionInputSerializer(data=data)
    ...
    def test_invalid_amount_negative(self):
        ...
        data = {'amount': '-50', 'currency': 'USD', 'trans_status': 'deposit'}
        serializer = TransactionInputSerializer(data=data)
        self.assertFalse(serializer.is_valid())
...
class TransactionFilterSerializerTest(TestCase):
    ...
    def test_valid_filter_data(self):
        ...
        data = {'start_date': '2024-01-01', 'end_date': '2024-01-31', 'category': 'Food', 'trans_status': 'deposit', 'page': '1'}
