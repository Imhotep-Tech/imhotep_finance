         ...
         <div className="relative w-full max-w-md">
          ...
          >
            ...
            <div className="my-8 flex items-center">
             ...
             >
              {/* coin / finance icon */}
              <svg className="w-5 h-5 mr-3" viewBox="0 0 24 24" fill="#366c6b">
                <circle cx="12" cy="12" r="8" opacity="0.15" />
                <path d="M12.5 8c-.83 0-1.5.67-1.5 1.5S11.67 11 12.5 11H14v2h-1.5C11.67 13 11 13.67 11 14.5S11.67 16 12.5 16 14 15.33 14 14.5V13h1v-2h-1v-.5C14 9.67 13.33 9 12.5 9z" />
              </svg>
